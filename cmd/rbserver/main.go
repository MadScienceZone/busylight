...
func main() {
	...
	http.HandleFunc("/readerboard/v1/alloff", readerboard.WrapHandler(readerboard.AllLightsOff, configData))
	http.HandleFunc("/readerboard/v1/bitmap", readerboard.WrapHandler(readerboard.Bitmap, configData))
	http.HandleFunc("/readerboard/v1/clear", readerboard.WrapHandler(readerboard.Clear, configData))
	http.HandleFunc("/readerboard/v1/color", readerboard.WrapHandler(readerboard.Color, configData))
	http.HandleFunc("/readerboard/v1/flash", readerboard.WrapHandler(readerboard.Flash, configData))
	http.HandleFunc("/readerboard/v1/font", readerboard.WrapHandler(readerboard.Font, configData))
	http.HandleFunc("/readerboard/v1/graph", readerboard.WrapHandler(readerboard.Graph, configData))
	http.HandleFunc("/readerboard/v1/light", readerboard.WrapHandler(readerboard.Light, configData))
	http.HandleFunc("/readerboard/v1/move", readerboard.WrapHandler(readerboard.Move, configData))
	http.HandleFunc("/readerboard/v1/off", readerboard.WrapHandler(readerboard.Off, configData))
	http.HandleFunc("/readerboard/v1/scroll", readerboard.WrapHandler(readerboard.Scroll, configData))
	http.HandleFunc("/readerboard/v1/strobe", readerboard.WrapHandler(readerboard.Strobe, configData))
	http.HandleFunc("/readerboard/v1/test", readerboard.WrapHandler(readerboard.Test, configData))
	http.HandleFunc("/readerboard/v1/text", readerboard.WrapHandler(readerboard.Text, configData))
